    ...
    >
      <Popover className="relative h-full">
        <Popover.Button className="h-full">
          <div className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-md transition-colors duration-200 group">
            {/* Cart Icon */}
            <svg
            ...
            {/* Cart Count Badge */}
            {totalItems > 0 && (
              <span className="absolute -top-1 -right-1 bg-coral-red text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
                {totalItems}
              </span>
            )}
